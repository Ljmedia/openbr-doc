...
\column{.3\textwidth}
  \begin{block}{Future}
  \centering
  \includegraphics[height=0.15\textheight]{img/phi} \\
  \includegraphics[height=0.15\textheight]{img/nvidia} \\
  \includegraphics[height=0.15\textheight]{img/ati} \\
  \includegraphics[height=0.15\textheight]{img/apu}
  \end{block}
\end{columns}
\end{frame}
